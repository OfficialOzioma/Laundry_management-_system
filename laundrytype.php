...
<body class="hold-transition skin-blue sidebar-mini">
    ...
    <div class="wrapper">
            ...
            <section class="content">
                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        ...
                        <button id="newType" type="button" class="btn btn-success btn-sm"> New Type <span
        ...
        <footer class="main-footer">
            ...
            <strong>Copyright &copy; <?= date('Y'); ?> <a href="http://www.google.com">Laundry App</a>.</strong> All
            rights reserved.
        </footer>
